...
setuptools.setup(
    ...
    description="# Cryptocurrency Bot ## Usage* Clone the repo and use exchange_utils.py and auth.py as normal modules.* API keys are required for each exchange you use..",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/cryptobot",  # 模块github地址
